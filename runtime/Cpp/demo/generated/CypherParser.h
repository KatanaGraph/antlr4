...
public:
  enum {
    ...
    NOT = 76, IN = 77, STARTS = 78, ENDS = 79, CONTAINS = 80, IS = 81, NA = 82, 
  ...
  enum {
    ...
    RuleOC_FunctionInvocation = 73, RuleOC_FunctionName = 74, RuleOC_ExplicitProcedureInvocation = 75, 
    RuleOC_ImplicitProcedureInvocation = 76, RuleOC_ProcedureResultField = 77, 
    RuleOC_ProcedureName = 78, RuleOC_Namespace = 79, RuleOC_ListComprehension = 80, 
    RuleOC_PatternComprehension = 81, RuleOC_PropertyLookup = 82, RuleOC_CaseExpression = 83, 
    RuleOC_CaseAlternatives = 84, RuleOC_Variable = 85, RuleOC_NumberLiteral = 86, 
    RuleOC_MapLiteral = 87, RuleOC_Parameter = 88, RuleOC_PropertyExpression = 89, 
    RuleOC_PropertyKeyName = 90, RuleOC_IntegerLiteral = 91, RuleOC_DoubleLiteral = 92, 
    RuleOC_SchemaName = 93, RuleOC_ReservedWord = 94, RuleOC_SymbolicName = 95, 
    RuleOC_LeftArrowHead = 96, RuleOC_RightArrowHead = 97, RuleOC_Dash = 98
  };
