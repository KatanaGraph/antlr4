...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitOC_StringListNullOperatorExpression(CypherParser::OC_StringListNullOperatorExpressionContext *context) = 0;

    virtual antlrcpp::Any visitOC_ListOperatorExpression(CypherParser::OC_ListOperatorExpressionContext *context) = 0;

    virtual antlrcpp::Any visitOC_StringOperatorExpression(CypherParser::OC_StringOperatorExpressionContext *context) = 0;

    virtual antlrcpp::Any visitOC_NullOperatorExpression(CypherParser::OC_NullOperatorExpressionContext *context) = 0;
    ...
    virtual antlrcpp::Any visitOC_CaseAlternatives(CypherParser::OC_CaseAlternativesContext *context) = 0;
