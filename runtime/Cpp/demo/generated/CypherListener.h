...
public:
  ...
  virtual void enterOC_CaseAlternatives(CypherParser::OC_CaseAlternativesContext *ctx) = 0;
  virtual void exitOC_CaseAlternatives(CypherParser::OC_CaseAlternativesContext *ctx) = 0;
